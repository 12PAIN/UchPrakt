...
Было принято решение создать комплекс примеров, базирующийся на одном и том же исходном коде. Читатель будет познавать основы отладки, проделывая разные алгоритмы на одном и том же фрагменте кода. Это позволит более наглядно показать различия между разными методами пошаговой отладки. Так читатель еще на этапе изучения сможет сам определить некоторые из них. Более наглядно эти различия были позднее представлены в виде таблицы, которая тоже включена в пособие.
